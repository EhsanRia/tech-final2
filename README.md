for the file you will next to set up your own virtual enviroment to allow you to run this application in your virtual enviroment you will need to install the flowing libraries:
flask
flask_login
mysql
mysql.connector
